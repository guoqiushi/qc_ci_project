...
tiff_path='/ds/images/remote_sensing/data/NetherlandsGeo/output'
sha_path='/b_test/guo/Task_1'
...
arial_image_list=show_file_abspath(tiff_path,'.tiff')[:10]
sha_list=show_file_abspath(sha_path,'.shp')[:10]
print(arial_image_list)
print(sha_list)

for i in range(10):
   rast(sha_list[i],arial_image_list[i],'/b_test/guo/Task_1/tiff'+'/{}.tiff'.format(i))